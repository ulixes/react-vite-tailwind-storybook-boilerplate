...
var getAct = async () => {
  ...
  if (typeof clonedReact.act == "function") reactAct = clonedReact.act;
    ...
    let deprecatedTestUtils = await import("./test-utils-JIDB3KO5.js");
...
var beforeAll = async () => {
  try {
    let { configure } = await import("./dist-JV3CDGRO.js"), act = await getAct();
...
//# sourceMappingURL=chunk-33LG5Q5P.js.map
